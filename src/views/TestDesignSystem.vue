        ...
        >
          <VCard variant="default">
            ...
            <p style="color: var(--color-text-muted)">
              이것은 기본 스타일의 카드 컴포넌트입니다. 경계선이 있고 배경색이
              적용됩니다.
            </p>
          </VCard>
          ...
          <VCard variant="elevated">
            ...
            <p style="color: var(--color-text-muted)">
              이것은 그림자 효과가 적용된 고도가 있는 카드입니다. 더 입체적으로
              보입니다.
            </p>
          </VCard>
          ...
          <VCard variant="outlined">
            ...
            <p style="color: var(--color-text-muted)">
              이것은 외곽선만 있는 카드입니다. 투명한 배경에 테두리만
              표시됩니다.
            </p>
          </VCard>
        </div>
      ...
      <div style="margin-top: var(--space-16)">
        <VCard>
          ...
          <div
            ...
            "
          >
            <div><strong>테마 모드:</strong> {{ themeMode }}</div>
            <div><strong>다크 모드:</strong> {{ isDark ? 'Yes' : 'No' }}</div>
            <div>
              <strong>시스템 다크 모드:</strong>
                ...
                :style="{
                  backgroundColor:
                    themeMode === 'light'
                      ? 'var(--color-primary)'
                      : 'transparent',
                  color: themeMode === 'light' ? 'white' : 'var(--color-text)',
                }"
                ...
                :style="{
                  backgroundColor:
                    themeMode === 'dark'
                      ? 'var(--color-primary)'
                      : 'transparent',
                  color: themeMode === 'dark' ? 'white' : 'var(--color-text)',
                }"
                @click="setTheme('dark')"
              >
                다크
                ...
                :style="{
                  backgroundColor:
                    themeMode === 'system'
                      ? 'var(--color-primary)'
                      : 'transparent',
                  color: themeMode === 'system' ? 'white' : 'var(--color-text)',
                }"
